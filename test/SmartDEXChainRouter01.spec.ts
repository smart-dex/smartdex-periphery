...
enum RouterVersion {
  SmartDEXChainRouter01 = 'SmartDEXChainRouter01',
  SmartDEXChainRouter = 'SmartDEXChainRouter'
}

describe('SmartDEXChainRouter{01,}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.SmartDEXChainRouter01]: fixture.router01,
        [RouterVersion.SmartDEXChainRouter]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SmartDEXChainRouter01]: 102968,
              [RouterVersion.SmartDEXChainRouter]: 102990
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SmartDEXChainRouter01]: 139872,
              [RouterVersion.SmartDEXChainRouter]: 139872
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
